                    ...
                    <OffcanvasBody>
                        ...
                        {isAdmin &&
                            <>
                                ...
                                <OffCanvasA light={light} to={'/admin/menu'} className={'mb-2'}>Gestion des menus</OffCanvasA>
                                <OffCanvasA light={light} to={'/admin/reservation'} className={'mb-2'}>Gestion des réservations</OffCanvasA>
                            </>
                        }
