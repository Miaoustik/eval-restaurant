 ...
 */
final class Version20230423111414 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT NOT NULL, rotation_id INT DEFAULT NULL, customer_number SMALLINT NOT NULL, allergens TEXT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_42C84955326CE1FB ON reservation (rotation_id)');
        $this->addSql('CREATE TABLE rotation (id INT NOT NULL, max_customer_id INT NOT NULL, horaire_day_id INT NOT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, customer_number SMALLINT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_297C98F12E3B42DC ON rotation (max_customer_id)');
        $this->addSql('CREATE INDEX IDX_297C98F118A6A2CD ON rotation (horaire_day_id)');
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, number SMALLINT NOT NULL, allergens TEXT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT FK_42C84955326CE1FB FOREIGN KEY (rotation_id) REFERENCES rotation (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE rotation ADD CONSTRAINT FK_297C98F118A6A2CD FOREIGN KEY (horaire_day_id) REFERENCES horaire_day (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation DROP CONSTRAINT FK_42C84955326CE1FB');
        $this->addSql('ALTER TABLE rotation DROP CONSTRAINT FK_297C98F12E3B42DC');
        $this->addSql('ALTER TABLE rotation DROP CONSTRAINT FK_297C98F118A6A2CD');
